...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe(self):
        ...
        #print(res.data['id'] ,Recipe.objects.get(id) , '-------------------tt' )
    ...
    def test_update_user_returns_error(self):
        """Test chaning the recipe user results is an error"""
    ...
    def test_delete_recipe_other_users_recipe_error(self):
        """Test trying to deleting another user receipe gives error"""
        new_user= create_user(email='user2@example.com',password='test123') 
    ...
    def test_create_recipe_with_new_tags(self):
        """Test for create recipe with new tag"""
        payload={
    ...
    def test_create_recipe_with_existing_tags(self):
        """Test for creating recipe with existing tags"""
        ...
        payload={
            ...
            'price':Decimal('4.50'),
            'link': 'https://example.com/recipe.pdf',
            'description': 'Sample recipe description3',
    ...
    def test_update_recipe_assing_tag(self):
        """Test asssing an exsting when updating recipe"""
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes':'30',
            'price':Decimal('4.50'),
            'ingredeints':[{'name':'Cauliflower'},{'name':'Salt'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
        ...
        for ingredient in payload['ingredeints']:
    ...
    def test_create_recipe_with_existing_ingredient(self):
        """Test for creating recipe with existing ingredients"""
    ...
    def test_update_recipe_assing_ingredient(self):
        """Test asssing an exsting when updating ingredient"""
